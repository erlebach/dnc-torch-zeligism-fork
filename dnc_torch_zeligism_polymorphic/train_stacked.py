...
def parse_arguments():
    ...
    parser.add_argument('--log_dir', type=str, default='logs/stacked', help='Directory for TensorBoard logs')
...
def train(model: nn.Module, task: RepeatCopy, args: argparse.Namespace) -> None:
    ...
    for i in range(args.num_examples):
        ...
        if (i + 1) % args.checkpoint == 0:
            ...
            print(f"[{i+1}/{args.num_examples}] Loss = {loss.item():.3f}, Examples/sec = {examples_per_second:.2f}")
